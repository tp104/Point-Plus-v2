...
const RegistrationScreen = () => {
  ...
  let registerOnPress = () => {
    ...
    db.transaction(function (tx) {
      tx.executeSql(
        'INSERT INTO student_table (student_name, student_dept, student_sem, student_div, student_email, student_password, student_points) VALUES (?,?,?,?,?,?,?)',
        [name, value1, value2, value3, email, password, points],
        (tx, results) => {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={{ fontSize: 25, color: '#000080', paddingBottom: 10, marginBottom: 80, borderBottomColor: '#3173de', borderBottomWidth: 1, }}>STUDENT REGISTRATION</Text>
